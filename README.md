...
This repository documents my one-month MSc Bioinformatics internship project focused on RNA-Seq transcriptome analysis of Neobractatin-treated HeLa cells. It includes the complete computational workflow, project notes, scripts, results, and report developed during the internship.
